-------------------------------------------------------------------------------
-- Dice Master (C) 2025 <The League of Lordaeron> - Moon Guard
-------------------------------------------------------------------------------
...
local altPowerBars = {
	...
	["morale-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/morale_";
		frame = false;
		background = false;
		fill = true;
		spark = true;
	...
	["sanctum-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/sanctum-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = true;
	...
	["warden-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/warden-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["archer-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/archer-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["mana-gems-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/mana-gems-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["phoenix-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/phoenix-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["holy-power-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/holy-power-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["balance-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/balance-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = true;
	...
	["druid-seed-bar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/druid-seed-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["ChromaticEssenceBar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/ChromaticEssenceBar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["PumpkinBar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/PumpkinBar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["EtherealBar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/EtherealBar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["BloodMageBar"] = {
		path = "Interface/AddOns/DiceMaster/Texture/UnitPowerBar/BloodMage_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
...
local function OnEnter( self )
	...
	GameTooltip:AddLine( "Custom Resource", 0.5, 0.5, 0.5 );
...
local methods = {
	ApplyTextures = function( self, texturePath, powerName, powerTooltip, displayedValue, color, flashEnabled )
		...
		-- Some UnitPowerBar skins are double size!
		if altPowerBars[texturePath].doubleHeight then
			self:SetHeight( self.defaultHeight * 2 )
		else
